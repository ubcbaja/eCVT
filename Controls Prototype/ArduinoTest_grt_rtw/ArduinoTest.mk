...
## Generated on : Sun Jan 19 22:06:27 2020
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\ArduinoTest.exe
...
COMPILER_COMMAND_FILE     = ArduinoTest_comp.rsp
CMD_FILE                  = ArduinoTest.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ArduinoTest.exe
...
DEFINES_STANDARD = -DMODEL=ArduinoTest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\ArduinoTest_grt_rtw\ArduinoTest.c $(START_DIR)\ArduinoTest_grt_rtw\ArduinoTest_data.c $(START_DIR)\ArduinoTest_grt_rtw\rtGetInf.c $(START_DIR)\ArduinoTest_grt_rtw\rtGetNaN.c $(START_DIR)\ArduinoTest_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj ArduinoTest.obj ArduinoTest_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\ArduinoTest_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ArduinoTest_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
